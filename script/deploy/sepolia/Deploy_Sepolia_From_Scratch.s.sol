...
/**
 * @notice Script used for the first deployment of Byzantine contracts to Sepolia
 * forge script script/deploy/sepolia/Deploy_Sepolia_From_Scratch.s.sol --rpc-url $SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --broadcast --etherscan-api-key $ETHERSCAN_API_KEY --verify -vvvv
 */
contract Deploy_Sepolia_From_Scratch is ExistingDeploymentParser {
    function run() external {
        _parseInitialDeploymentParams("script/configs/sepolia/Deploy_from_scratch.sepolia.config.json");
        ...
        logAndOutputContractAddresses("script/output/sepolia/Deploy_from_scratch.sepolia.config.json");
    }
